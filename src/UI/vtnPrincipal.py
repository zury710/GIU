...
class Ui_vtnPrincipal(object):
    def setupUi(self, vtnPrincipal):
        ...
        self.txtEmail.setGeometry(QRect(210, 230, 301, 20))
        ...
        self.cbSexo.setGeometry(QRect(210, 190, 221, 24))
    ...
    def retranslateUi(self, vtnPrincipal):
        ...
        self.cbSexo.setItemText(1, QCoreApplication.translate("vtnPrincipal", u"Mujer", None))
        self.cbSexo.setItemText(2, QCoreApplication.translate("vtnPrincipal", u"Hombre", None))
